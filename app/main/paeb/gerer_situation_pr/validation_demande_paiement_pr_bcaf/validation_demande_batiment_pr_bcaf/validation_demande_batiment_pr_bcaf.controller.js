(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_batiment_pr_bcafController', Validation_demande_batiment_pr_bcafController);
    /** @ngInject */
    function Validation_demande_batiment_pr_bcafController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
...
/**********************************debut demande_batiment_pr****************************************/
      ...
      apiFactory.getAPIgeneraliserREST("demande_batiment_pr/index",'menu','getdemandeByInvalide').then(function(result)
      {
