(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_debut_travaux_pr_bcafController', Validation_demande_debut_travaux_pr_bcafController);
    /** @ngInject */
    function Validation_demande_debut_travaux_pr_bcafController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
