(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_latrine_pr_bcafController', Validation_demande_latrine_pr_bcafController);
    /** @ngInject */
    function Validation_demande_latrine_pr_bcafController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
...
/**********************************debut demande_latrine_pr****************************************/
      apiFactory.getAPIgeneraliserREST("demande_latrine_pr/index",'menu','getdemandeInvalide').then(function(result)
      {
