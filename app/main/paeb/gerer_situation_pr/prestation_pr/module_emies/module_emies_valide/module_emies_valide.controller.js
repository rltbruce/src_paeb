(function ()
{
    ...
    angular
        ...
        .controller('Module_emies_valideController', Module_emies_valideController);
    /** @ngInject */
    function Module_emies_valideController($mdDialog, $scope, apiFactory, $state,apiUrl,$http)
    {
		   var vm = this;
...
/**********************************debut passation_marches_moe****************************************/
  ...
  apiFactory.getAPIgeneraliserREST("module_emies/index",'menu','getmodule_emiesByDate').then(function(result)
  {
