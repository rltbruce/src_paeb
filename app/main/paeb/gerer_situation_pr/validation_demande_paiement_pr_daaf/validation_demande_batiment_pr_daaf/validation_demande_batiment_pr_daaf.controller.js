(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_batiment_pr_daafController', Validation_demande_batiment_pr_daafController);
    /** @ngInject */
    function Validation_demande_batiment_pr_daafController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
...
/**********************************debut demande_batiment_pr****************************************/
      ...
      apiFactory.getAPIgeneraliserREST("demande_batiment_pr/index",'menu','getdemandeByValidedpfi').then(function(result)
      {
