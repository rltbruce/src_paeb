(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_mobilier_pr_daafController', Validation_demande_mobilier_pr_daafController);
    /** @ngInject */
    function Validation_demande_mobilier_pr_daafController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
...
/**********************************debut demande_mobilier_pr****************************************/
      apiFactory.getAPIgeneraliserREST("demande_mobilier_pr/index",'menu','getdemandeByValidedpfi').then(function(result)
      {
