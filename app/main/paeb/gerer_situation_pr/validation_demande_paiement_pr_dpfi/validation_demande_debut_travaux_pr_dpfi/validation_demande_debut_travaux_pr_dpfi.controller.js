(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_debut_travaux_pr_dpfiController', Validation_demande_debut_travaux_pr_dpfiController);
    /** @ngInject */
    function Validation_demande_debut_travaux_pr_dpfiController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
...
/**********************************debut demande_debut_travaux_pr****************************************/
    apiFactory.getAPIgeneraliserREST("demande_debut_travaux_pr/index",'menu','getdemandeByValidebcaf').then(function(result)
    {
