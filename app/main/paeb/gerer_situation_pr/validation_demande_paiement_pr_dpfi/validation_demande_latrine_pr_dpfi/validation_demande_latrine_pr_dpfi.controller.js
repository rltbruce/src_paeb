(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_latrine_pr_dpfiController', Validation_demande_latrine_pr_dpfiController);
    /** @ngInject */
    function Validation_demande_latrine_pr_dpfiController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
...
/**********************************debut demande_latrine_pr****************************************/
      apiFactory.getAPIgeneraliserREST("demande_latrine_pr/index",'menu','getdemandeByValidebcaf').then(function(result)
      {
