(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_fin_travaux_pr_dpfiController', Validation_demande_fin_travaux_pr_dpfiController);
    /** @ngInject */
    function Validation_demande_fin_travaux_pr_dpfiController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
...
//col table
    ...
    apiFactory.getAPIgeneraliserREST("demande_fin_travaux_pr/index",'menu','getdemandeByValidebcaf').then(function(result)
    {
