(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_mobilier_pr_dpfiController', Validation_demande_mobilier_pr_dpfiController);
    /** @ngInject */
    function Validation_demande_mobilier_pr_dpfiController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
...
/**********************************debut demande_mobilier_pr****************************************/
      apiFactory.getAPIgeneraliserREST("demande_mobilier_pr/index",'menu','getdemandeByValidebcaf').then(function(result)
      {
