...
(function ()
{
    ...
    angular
        ...
        .controller('Convention_need_avenantController', Convention_need_avenantController);
    /** @ngInject */
    function Convention_need_avenantController($mdDialog, $scope, apiFactory, $state,$cookieStore,apiUrl,$http,apiUrlFile,apiUrlexcel)
    {
        ...
        apiFactory.getAPIgeneraliserREST("convention_cisco_feffi_entete/index",'menu','getconventionvalideneedavenant').then(function(result)
        {
