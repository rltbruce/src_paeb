...
//col table
        ...
        $scope.uploadFile_batiment_moe = function(event)
       {
          console.dir(event);
          var files = event.target.files;
          vm.myFile = files;
...
//col table
        ...
        $scope.uploadFile_latrine_moe = function(event)
       {
          console.dir(event);
          var files = event.target.files;
          vm.myFile = files;
...
//col table
        ...
        $scope.uploadFile_fin_travaux_moe = function(event)
       {
          console.dir(event);
          var files = event.target.files;
          vm.myFile = files;
...
/************************************************debut latrine_mpe*************************************************/
        ...
        vm.selectionDemande_latrine_mpe= function (item)
        {
           ...
           if(item.id!=0)
           {
            apiFactory.getAPIgeneraliserREST("justificatif_latrine_pre/index",'id_demande_latrine_pre',vm.selectedItemDemande_latrine_mpe.id).then(function(result)
            {
        ...
        $scope.uploadFilelatrine_mpe = function(event)
       {
        ...
        { 
          if (NouvelItemJustificatif_latrine_mpe == false)
          {
            ...
            vm.alljustificatif_latrine_mpe.push(items);
            vm.alljustificatif_latrine_mpe.forEach(function(mem)
            {
              if(mem.$selected==true)
              {
...
/************************************************debut mobilier_mpe*************************************************/
        ...
        vm.selectionDemande_mobilier_mpe= function (item)
        {
           ...
           if(item.id!=0)
           {
            apiFactory.getAPIgeneraliserREST("justificatif_mobilier_pre/index",'id_demande_mobilier_pre',vm.selectedItemDemande_mobilier_mpe.id).then(function(result)
            {
        ...
        $scope.uploadFilemobilier_mpe = function(event)
       {
        ...
        { 
          if (NouvelItemJustificatif_mobilier_mpe == false)
          {
            ...
            vm.alljustificatif_mobilier_mpe.push(items);
            vm.alljustificatif_mobilier_mpe.forEach(function(mem)
            {
              if(mem.$selected==true)
              {
