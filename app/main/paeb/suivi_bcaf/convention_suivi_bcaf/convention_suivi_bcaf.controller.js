...
/********************************************Debut entreprise******************************************/
        ...
        vm.alljustificatif_latrine_mpe = [] ;
        ...
        vm.alljustificatif_mobilier_mpe = [] ;
            ...
            return new Promise(function (resolve, reject) 
            {
                switch (session)
                {
                 case 'BCAF':
                            ...
                            apiFactory.getAPIgeneraliserREST("avenant_convention/index",'menu','getavenantByconvention','id_convention_entete',item.id).then(function(result)
                            {
              ...
              switch (vm.session)
              {
               ...
               case 'BCAF':
                          ...
                          apiFactory.getAPIgeneraliserREST("demande_mobilier_prestataire/index","menu","getdemandeBycontrat",'id_contrat_prestataire',vm.selectedItemContrat_prestataire.id).then(function(result)
                            ...
                            apiFactory.getAPIgeneraliserREST("dossier_prestataire/index",'menu','getdocumentBycontrat','id_contrat_prestataire',item.id).then(function(result)
                           {
...
/************************************************debut batiment_mpe*************************************************/
        ...
        vm.modifierDemande_batiment_mpe = function(item)
        {
            ...
            /*apiFactory.getAPIgeneraliserREST("batiment_construction/index",'menu','getbatimentByContrat_prestataire','id_contrat_prestataire',vam.selectedItemContrat_prestataire.id).then(function(result)
            {
...
//col table
        ...
        $scope.uploadFilebatiment_mpe = function(event)
       {
        ...
        {          
            if (suppression!=1)
            {   console.log('2');
console.log(currentItemJustificatif_batiment_mpe);
                ...
                if(just[0])
                {
                   if((just[0].description   != currentItemJustificatif_batiment_mpe.description )
                    ||(just[0].fichier   != currentItemJustificatif_batiment_mpe.fichier ))                   
                      { 
                         insert_in_baseJustificatif_batiment_mpe(item,suppression);console.log('3');
                      }
                      else
                      {  console.log('4');
                        item.$selected = true;
...
//col table
        ...
        $scope.uploadFilelatrine_mpe = function(event)
       {
        ...
        vm.annulerJustificatif_latrine_mpe = function(item)
        {
          ...
          {
            vm.alljustificatif_latrine_mpe = vm.alljustificatif_latrine_mpe.filter(function(obj)
            {
        ...
        {
             if (!vm.alljustificatif_latrine_mpe) return;
             vm.alljustificatif_latrine_mpe.forEach(function(item)
             {
                item.$selected = false;
             });
        ...
        vm.modifierJustificatif_latrine_mpe = function(item)
        {
            ...
            $scope.vm.alljustificatif_latrine_mpe.forEach(function(jus) {
              jus.$edit = false;
            });
        ...
        {          
            if (suppression!=1)
            {
               var just = vm.alljustificatif_latrine_mpe.filter(function(obj)
                {
...
//col table
        ...
        function insert_in_basePaiement_latrine_mpe(paiement_latrine_mpe,suppression)
        {
            ...
            var datas = $.param({
                    ...
                    id_demande_latrine_pre: vm.selectedItemDemande_latrine_mpe.id,
                    validation : 0            
                });
                //console.log(datas);
                //factory
...
//col table
        ...
        $scope.uploadFilemobilier_mpe = function(event)
       {
        ...
        vm.annulerJustificatif_mobilier_mpe = function(item)
        {
          ...
          {
            vm.alljustificatif_mobilier_mpe = vm.alljustificatif_mobilier_mpe.filter(function(obj)
            {
        ...
        {
             if (!vm.alljustificatif_mobilier_mpe) return;
             vm.alljustificatif_mobilier_mpe.forEach(function(item)
             {
                item.$selected = false;
             });
        ...
        vm.modifierJustificatif_mobilier_mpe = function(item)
        {
            ...
            $scope.vm.alljustificatif_mobilier_mpe.forEach(function(jus) {
              jus.$edit = false;
            });
        ...
        {          
            if (suppression!=1)
            {
               var just = vm.alljustificatif_mobilier_mpe.filter(function(obj)
                {
...
//col table
        ...
        function insert_in_basePaiement_mobilier_mpe(paiement_mobilier_mpe,suppression)
        {
            ...
            var datas = $.param({
                    ...
                    id_demande_mobilier_pre: vm.selectedItemDemande_mobilier_mpe.id,
                    validation : 0            
                });
                //console.log(datas);
                //factory
