            ...
            {   
                ...
                if (NouvelItemContrat_prestataire == false)
                {
                    ...
                    if(suppression==0)
                    {
                        ...
                        vm.selectedItemContrat_prestataire.date_prev_deb_trav = contrat_prestataire.date_prev_deb_trav ;
                        vm.selectedItemContrat_prestataire.date_reel_deb_trav = contrat_prestataire.date_reel_deb_trav ;
                        vm.selectedItemContrat_prestataire.delai_execution = contrat_prestataire.delai_execution ;
                ...
                else
                {
                  ...
                  contrat_prestataire.date_prev_deb_trav = contrat_prestataire.date_prev_deb_trav;
                  contrat_prestataire.date_reel_deb_trav = contrat_prestataire.date_reel_deb_trav;
                  contrat_prestataire.delai_execution = contrat_prestataire.delai_execution;
