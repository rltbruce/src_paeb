(function ()
{
    ...
    .service('fileUpload', ['$http', function ($http) {
      this.uploadFileToUrl = function(file, uploadUrl){
        ...
        .controller('Validation_demande_payement_prestataireController', Validation_demande_payement_prestataireController);
    /** @ngInject */
    function Validation_demande_payement_prestataireController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
