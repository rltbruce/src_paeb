(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_bcaf_latrine_prestataireController', Validation_demande_bcaf_latrine_prestataireController);
    /** @ngInject */
    function Validation_demande_bcaf_latrine_prestataireController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
        ...
        vm.dtOptions = {
          ...
          apiFactory.getAPIgeneraliserREST("demande_latrine_prestataire/index",'menu','getdemandeInvalide').then(function(result)
          {
