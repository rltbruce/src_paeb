(function ()
{
    ...
    .service('fileUpload', ['$http', function ($http) {
      this.uploadFileToUrl = function(file, uploadUrl){
        ...
        .controller('Validation_demande_bcaf_batiment_prestataireController', Validation_demande_bcaf_batiment_prestataireController);
    /** @ngInject */
    function Validation_demande_bcaf_batiment_prestataireController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
        ...
        vm.dtOptions = {
          ...
          apiFactory.getAPIgeneraliserREST("demande_batiment_prestataire/index",'menu','getdemandeInvalide').then(function(result)
          {
