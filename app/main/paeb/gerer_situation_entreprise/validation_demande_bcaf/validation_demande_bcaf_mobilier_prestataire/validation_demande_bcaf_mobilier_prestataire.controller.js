(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_bcaf_mobilier_prestataireController', Validation_demande_bcaf_mobilier_prestataireController);
    /** @ngInject */
    function Validation_demande_bcaf_mobilier_prestataireController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
        ...
        vm.dtOptions = {
          ...
          apiFactory.getAPIgeneraliserREST("demande_mobilier_prestataire/index",'menu','getdemandeInvalide').then(function(result)
          {
