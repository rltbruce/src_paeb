...
(function ()
{
    ...
    /** @ngInject */
    function Convention_suivi_fp_bcafController($mdDialog, $scope, apiFactory, $state,$cookieStore,apiUrl,$http,apiUrlFile,apiUrlexcel,$stateParams)
    {
...
/********************************************Fin entreprise********************************************/
        vm.notification_mpe=0;
        vm.notification_moe=0;
...
//fonction selection item Demande_batiment_mpe
        ...
        function insert_in_baseFacture_moe_entete(facture_moe_entete,suppression)
        {
            ...
            var datas = $.param({
                    ...
                    statu_fact: vm.selectedItemFacture_moe_entete.statu_fact,
                    validation: 0               
                });
                console.log(datas);
                //factory
        ...
        function maj_in_baseFacture_moe_entete(facture_moe_entete,suppression,validation)
        {
            ...
            apiFactory.add("facture_moe_entete/index",datas, config).success(function (data)
            {
              ...
              facture_moe_entete.$edit = false;*/
              vm.selectedItemFacture_moe_entete = {};
              if (vm.notification_moe!=0)
              {
                vm.notification_moe = vm.notification_moe-1;
              }
...
vm.selectionAvance_demarrage= function (item)
{
   ...
   if(item.$edit!=false || item.$edit!=undefined)
   {
    ...
    vm.showbuttonValidationAvance_demarrage = true;
   }
...
function insert_in_baseAvance_demarrage(avance_demarrage,suppression)
{
    ...
    apiFactory.add("avance_demarrage/index",datas, config).success(function (data)
    {
      ...
      vm.selectedItemAvance_demarrage = {};
        ...
        vm.rejeterAvance_demarrage = function()
        {
        ...
        function maj_insert_avance_demarrage(avance_demarrage,suppression,validation)
        {
            ...
            apiFactory.add("avance_demarrage/index",datas, config).success(function (data)
            {
              ...
              //vm.selectedItemAvance_demarrage = {};
              vm.showbuttonValidationAvance_demarrage = false;
              //vm.showbuttonRejectionAvance_demarrage = false;
...
/************************************************debut facture*************************************************/
        ...
        { 
            ...
            vm.facture_mpe.push(items);
            vm.facture_mpe.forEach(function(cis)
            {
              if(cis.$selected==true)
                {
        ...
        vm.selectionFacture_mpe= function (item)
        {
           ...
           if(item.$edit!=false || item.$edit!=undefined)
           {
            ...
            vm.showbuttonValidationFacture_mpe = true;
           }
        ...
        {
             if (!vm.facture_mpe) return;
             vm.facture_mpe.forEach(function(item)
             {
                item.$selected = false;
             });
...
//console.log(facture_mpe);
        ...
        function maj_insertFacture_mpe(facture_mpe,suppression,validation)
        {
            ...
            {                
              ...
              if (vm.notification_mpe!=0)
              {
                vm.notification_mpe = vm.notification_mpe-1;
              }
          }).error(function (data){vm.showAlert('Error','Erreur lors de l\'insertion de donnée');});
