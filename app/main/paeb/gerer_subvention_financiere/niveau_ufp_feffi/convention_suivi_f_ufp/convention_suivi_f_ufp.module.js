(function ()
{
    ...
    {
        // State
        $stateProvider.state('app.paeb_gerer_subvention_financiere_niveau_ufp_feffi_convention_suivi_f_ufp', {
            url      : '/donnees-de-base/gerer_subvention_financiere/niveau_ufp_feffi/convention_suivi_f_ufp',
            views    : {
                'content@app': {
                    templateUrl: 'app/main/paeb/gerer_subvention_financiere/niveau_ufp_feffi/convention_suivi_f_ufp/convention_suivi_f_ufp.html',
        ...
        // Navigation
        msNavigationServiceProvider.saveItem('paeb.gerer_subvention_financiere.niveau_ufp_feffi.convention_suivi_f_ufp', {
            title: 'Validation et transfert (UFP)',
            icon  : 'icon-rotate-3d',
            state: 'app.paeb_gerer_subvention_financiere_niveau_ufp_feffi_convention_suivi_f_ufp',
            weight: 1,
            badge:vs,
            hidden:function()
            {
