(function ()
{
    ...
    {
        // State
        $stateProvider.state('app.paeb_gerer_subvention_financiere_niveau_daaf_feffi_validation_financiere_deblocage_feffi', {
            url      : '/donnees-de-base/gerer_subvention_financiere/validation_financiere_deblocage_feffi',
            views    : {
                'content@app': {
                    templateUrl: 'app/main/paeb/gerer_subvention_financiere/niveau_daaf_feffi/validation_financiere_deblocage_feffi/validation_financiere_deblocage_feffi.html',
        ...
        // Navigation
        msNavigationServiceProvider.saveItem('paeb.gerer_subvention_financiere.niveau_daaf_feffi.validation_financiere_deblocage_feffi', {
            title: 'Validation financiere feffi',
            icon  : 'icon-tile-four',
            state: 'app.paeb_gerer_subvention_financiere_niveau_daaf_feffi_validation_financiere_deblocage_feffi',
            weight: 3,
            badge:vs,
            hidden:function()
            {
