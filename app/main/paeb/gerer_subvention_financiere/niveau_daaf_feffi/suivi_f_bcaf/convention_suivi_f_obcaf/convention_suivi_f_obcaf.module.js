(function ()
{
    ...
    {
        // State
        $stateProvider.state('app.paeb_gerer_subvention_financiere_niveau_daaf_feffi_suivi_f_bcaf_convention_suivi_f_obcaf', {
            url      : '/donnees-de-base/gerer_subvention_financiere/niveau_daaf_feffi/suivi_f_bcaf/convention_suivi_f_obcaf',
            views    : {
                'content@app': {
                    templateUrl: 'app/main/paeb/gerer_subvention_financiere/niveau_daaf_feffi/suivi_f_bcaf/convention_suivi_f_obcaf/convention_suivi_f_obcaf.html',
