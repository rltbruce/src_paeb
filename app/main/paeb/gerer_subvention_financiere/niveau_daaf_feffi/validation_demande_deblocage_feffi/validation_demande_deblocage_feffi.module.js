(function ()
{
    ...
    {
        // State
        $stateProvider.state('app.paeb_gerer_subvention_financiere_niveau_daaf_feffi_validation_demande_deblocage_feffi', {
            url      : '/donnees-de-base/gerer_subvention_financiere/validation_demande_deblocage_feffi',
            views    : {
                'content@app': {
                    templateUrl: 'app/main/paeb/gerer_subvention_financiere/niveau_daaf_feffi/validation_demande_deblocage_feffi/validation_demande_deblocage_feffi.html',
        ...
        // Navigation
        msNavigationServiceProvider.saveItem('paeb.gerer_subvention_financiere.niveau_daaf_feffi.validation_demande_deblocage_feffi', {
            title: 'Validation Demande feffi',
            icon  : 'icon-tile-four',
            state: 'app.paeb_gerer_subvention_financiere_niveau_daaf_feffi_validation_demande_deblocage_feffi',
            weight: 2,
            badge:vs,
            hidden:function()
            {
    ...
    function notification($cookieStore,apiFactory,$interval,loginService)
    {
        ...
        if (id_user > 0) 
        {
            ...
            apiFactory.getOne("utilisateurs/index", id_user).then(function(result) 
            {
                ...
                {
                    $interval(function(){apiFactory.getDemande_realimentationByInvalide("count_demande_feffi",Number(1),"getcoutInvalide").then(function(result) 
                    {
