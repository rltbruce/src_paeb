...
/*******************************Debut initialisation suivi financement feffi******************************/
        ...
        apiFactory.getAPIgeneraliserREST("convention_cisco_feffi_entete/index",'menu','getconventionNeeddecaissfeffivalidation').then(function(result)
        {
      ...
      { 
        ...
        function insert_in_baseDecaiss_fonct_feffi(decaiss_fonct_feffi,suppression)
        {
            ...
            var datas = $.param({
                    ...
                    date_decaissement: convertionDate(decaiss_fonct_feffi.date_decaissement),
        ...
        {          
          ...
          {
            var justificatif_decaiss_fonct_feffi = result.data.response;
            if (justificatif_decaiss_fonct_feffi.length>0)
            {
            ...
            else
            {
              $mdDialog.show(
                ...
                .parent(angular.element(document.body))
                .title("cette validation n\'est pas autorisé")
                .textContent("La pièce justificative est vide")
                .ariaLabel('Alert')
                .ok('Fermer')
                .targetEvent()
              );
        ...
        $scope.uploadFiledecaiss_fonct_feffi = function(event)
       {
        ...
        { 
          if (NouvelItemJustificatif_decaiss_fonct_feffi == false)
          {
            ...
            vm.alljustificatif_decaiss_fonct_feffi.push(items);
                            ...
                            var datas = $.param({
                                ...
                                { 
                                  ...
                                  justificatif_decaiss_fonct_feffi.$selected = false;
                                    justificatif_decaiss_fonct_feffi.$edit = false;
                                    //justificatif_decaiss_fonct_feffi.fichier=currentItemJustificatif_decaiss_fonct_feffi.fichier;
                                    //.selectedItemJustificatif_decaiss_fonct_feffi = {};
