...
(function ()
{
    ...
    .service('fileUpload', ['$http', function ($http) {
      this.uploadFileToUrl = function(file, uploadUrl){
        ...
        .controller('Transfert_reliquat_bcafController', Transfert_reliquat_bcafController);
    /** @ngInject */
    function Transfert_reliquat_bcafController($mdDialog, $scope, apiFactory, $state,$cookieStore,apiUrl,$http,apiUrlFile,apiUrlexcel)
    {
...
/********************************************Fin reliquat********************************************/
        ...
        function insert_in_baseTransfert_reliquat(transfert_reliquat,suppression)
        {
            ...
            var datas = $.param({
                    ...
                    date_transfert:    convertionDate(transfert_reliquat.date_transfert),
