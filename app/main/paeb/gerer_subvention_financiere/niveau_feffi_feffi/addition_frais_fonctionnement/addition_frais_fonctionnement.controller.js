      ...
      apiFactory.getAPIgeneraliserREST("piece_justificatif_frais_fonction_feffi/index",'id_addition_frais',vm.selectedItemAddition_frais_fonctionnement.id).then(function(result)
      {
        ...
        $scope.uploadFile_addi = function(event)
       {
        ...
        function ajoutJustificatif_frais_fonction_feffi(justificatif_frais_fonction_feffi,suppression)
        {
            ...
            {
                apiFactory.getAPIgeneraliserREST("addition_frais_fonctionnement/index",'menu',"getaddition_frais_fonctionnementById",'id_addition',vm.selectedItemAddition_frais_fonctionnement.id).then(function(result)
                {
                  var addition_frais_fonctionnement_valide = result.data.response;
                  if (addition_frais_fonctionnement_valide.length !=0)
                  {
        ...
        function insert_in_baseJustificatif_frais_fonction_feffi(justificatif_frais_fonction_feffi,suppression)
        {
            ...
            var datas = $.param({
                    ...
                    id_addition_frais: vm.selectedItemAddition_frais_fonctionnement.id              
                });
                console.log(datas);
                //factory
