...
(function ()
{
    ...
    .service('fileUpload', ['$http', function ($http) {
      this.uploadFileToUrl = function(file, uploadUrl){
        ...
        .controller('Convention_suivi_odaafController', Convention_suivi_odaafController);
    /** @ngInject */
    function Convention_suivi_odaafController($mdDialog, $scope, apiFactory, $state,$cookieStore,apiUrl,$http,apiUrlFile,apiUrlexcel)
    {
...
/*******************************Debut initialisation suivi financement feffi******************************/ 
        ...
        vm.showbuttonNouvtransfert_daaf= true;vm.selectedItemTransfert_daaf = {} ;
        vm.alltransfert_daaf=[];
