(function ()
{
    ...
    {
        // State
        $stateProvider.state('app.paeb_gerer_subvention_operation_niveau_feffi_prestataire_suivi_bcaf_convention_suivi_bcaf', {
            url      : '/donnees-de-base/gerer_subvention_operation/niveau_feffi_prestataire/suivi_bcaf/convention_suivi_bcaf',
            views    : {
                'content@app': {
                    templateUrl: 'app/main/paeb/gerer_subvention_operation/niveau_feffi_prestataire/suivi_bcaf/convention_suivi_bcaf/convention_suivi_bcaf.html',
