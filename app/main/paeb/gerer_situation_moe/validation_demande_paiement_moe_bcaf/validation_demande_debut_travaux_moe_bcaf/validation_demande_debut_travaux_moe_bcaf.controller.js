(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_debut_travaux_moe_bcafController', Validation_demande_debut_travaux_moe_bcafController);
    /** @ngInject */
    function Validation_demande_debut_travaux_moe_bcafController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
...
/**********************************debut demande_debut_travaux_moe****************************************/
    apiFactory.getAPIgeneraliserREST("demande_debut_travaux_moe/index",'menu','getdemandeByInvalide').then(function(result)
    {
