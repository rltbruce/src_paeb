(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_fin_travaux_moe_bcafController', Validation_demande_fin_travaux_moe_bcafController);
    /** @ngInject */
    function Validation_demande_fin_travaux_moe_bcafController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
...
//col table
    ...
    apiFactory.getAPIgeneraliserREST("demande_fin_travaux_moe/index",'menu','getdemandeByInvalide').then(function(result)
    {
