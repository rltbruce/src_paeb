(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_mobilier_moe_bcafController', Validation_demande_mobilier_moe_bcafController);
    /** @ngInject */
    function Validation_demande_mobilier_moe_bcafController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
...
/**********************************debut demande_mobilier_moe****************************************/
      apiFactory.getAPIgeneraliserREST("demande_mobilier_moe/index",'menu','getdemandeByInvalide').then(function(result)
      {
