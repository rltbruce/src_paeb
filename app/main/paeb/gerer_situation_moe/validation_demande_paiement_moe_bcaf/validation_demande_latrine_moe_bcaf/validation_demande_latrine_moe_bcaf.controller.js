(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_latrine_moe_bcafController', Validation_demande_latrine_moe_bcafController);
    /** @ngInject */
    function Validation_demande_latrine_moe_bcafController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
...
/**********************************debut demande_latrine_moe****************************************/
      apiFactory.getAPIgeneraliserREST("demande_latrine_moe/index",'menu','getdemandeInvalide').then(function(result)
      {
