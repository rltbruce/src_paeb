(function ()
{
    ...
    /** @ngInject */
    function Police_assuranceController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
              ...
              if (NouvelItemPolice_assurance == false)
              {
                    ...
                    if(suppression==0)
                    {
                         var file= vm.myFile[0];
                          ...
                          var repertoire = 'police_assurance/';
                          var uploadUrl  = apiUrl + "importer_fichier/save_upload_file";
                          var getIdFile = vm.selectedItemPolice_assurance.id
                          ...
                          { 
                            ...
                            }).success(function(data)
                            {
                                ...
                                {
                                  police_assurance.fichier=repertoire+data['nomFile'];
                                  var datas = $.param({
                                        supprimer: suppression,
                                        id:        getIdFile,
                                        description: police_assurance.description,
                    ...
                    {    
                      ...
                      vm.showbuttonNouvPolice = true;
                      var chemin= vm.selectedItemPolice_assurance.fichier;
                      var fd = new FormData();
