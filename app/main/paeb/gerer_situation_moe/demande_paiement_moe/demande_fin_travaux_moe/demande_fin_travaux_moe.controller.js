(function ()
{
    ...
    /** @ngInject */
    function Demande_fin_travaux_moeController($mdDialog, $scope, apiFactory, $state,apiUrl,$http)
    {
		    var vm = this;
        ...
        function insert_in_baseDemande_fin_travaux_moe(demande_fin_travaux_moe,suppression)
        {
            ...
            {   
                ...
                if (NouvelItemDemande_fin_travaux_moe == false)
                {
                    ...
                    if(suppression==0)
                    {
                        /*vm.selectedItemDemande_fin_travaux_moe.objet   = demande_fin_travaux_moe.objet ;
                        vm.selectedItemDemande_fin_travaux_moe.description   = demande_fin_travaux_moe.description ;
                        vm.selectedItemDemande_fin_travaux_moe.ref_facture   = demande_fin_travaux_moe.ref_facture ;
                        vm.selectedItemDemande_fin_travaux_moe.montant   = demande_fin_travaux_moe.montant ;*/
                        vm.selectedItemDemande_fin_travaux_moe.tranche = tran[0] ;
                        /*vm.selectedItemDemande_fin_travaux_moe.cumul = demande_fin_travaux_moe.cumul ;
                        vm.selectedItemDemande_fin_travaux_moe.anterieur = demande_fin_travaux_moe.anterieur ;*/
                        ...
                        /*vm.selectedItemDemande_fin_travaux_moe.reste = demande_fin_travaux_moe.reste ;
                        vm.selectedItemDemande_fin_travaux_moe.date   = demande_fin_travaux_moe.date ;*/
                ...
                {
                  /*demande_fin_travaux_moe.objet   = demande_fin_travaux_moe.objet ;
                  demande_fin_travaux_moe.description   = demande_fin_travaux_moe.description ;
                  demande_fin_travaux_moe.ref_facture   = demande_fin_travaux_moe.ref_facture ;
                  demande_fin_travaux_moe.montant   = demande_fin_travaux_moe.montant ;*/
                  demande_fin_travaux_moe.tranche = tran[0] ;
                  /*demande_fin_travaux_moe.cumul = demande_fin_travaux_moe.cumul ;
                  demande_fin_travaux_moe.anterieur = demande_fin_travaux_moe.anterieur ;*/
                  demande_fin_travaux_moe.periode = tran[0].periode ;
                  demande_fin_travaux_moe.pourcentage = tran[0].pourcentage ;
                  /*demande_fin_travaux_moe.reste = demande_fin_travaux_moe.reste ;
                  demande_fin_travaux_moe.date   = demande_fin_travaux_moe.date ;*/
