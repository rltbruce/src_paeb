(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_debut_travaux_moe_dpfiController', Validation_demande_debut_travaux_moe_dpfiController);
    /** @ngInject */
    function Validation_demande_debut_travaux_moe_dpfiController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
...
/**********************************debut demande_debut_travaux_moe****************************************/
    apiFactory.getAPIgeneraliserREST("demande_debut_travaux_moe/index",'menu','getdemandeByValidebcaf').then(function(result)
    {
