(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_batiment_moe_dpfiController', Validation_demande_batiment_moe_dpfiController);
    /** @ngInject */
    function Validation_demande_batiment_moe_dpfiController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
...
/**********************************debut demande_batiment_moe****************************************/
      ...
      apiFactory.getAPIgeneraliserREST("demande_batiment_moe/index",'menu','getdemandeByValidebcaf').then(function(result)
      {
