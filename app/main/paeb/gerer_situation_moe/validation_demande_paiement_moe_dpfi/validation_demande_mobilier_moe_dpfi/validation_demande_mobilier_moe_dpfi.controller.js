(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_mobilier_moe_dpfiController', Validation_demande_mobilier_moe_dpfiController);
    /** @ngInject */
    function Validation_demande_mobilier_moe_dpfiController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
...
/**********************************debut demande_mobilier_moe****************************************/
      apiFactory.getAPIgeneraliserREST("demande_mobilier_moe/index",'menu','getdemandeByValidebcaf').then(function(result)
      {
