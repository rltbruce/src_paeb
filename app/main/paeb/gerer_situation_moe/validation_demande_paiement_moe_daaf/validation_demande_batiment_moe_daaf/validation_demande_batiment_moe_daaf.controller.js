(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_batiment_moe_daafController', Validation_demande_batiment_moe_daafController);
    /** @ngInject */
    function Validation_demande_batiment_moe_daafController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
...
/**********************************debut demande_batiment_moe****************************************/
      ...
      apiFactory.getAPIgeneraliserREST("demande_batiment_moe/index",'menu','getdemandeByValidedpfi').then(function(result)
      {
