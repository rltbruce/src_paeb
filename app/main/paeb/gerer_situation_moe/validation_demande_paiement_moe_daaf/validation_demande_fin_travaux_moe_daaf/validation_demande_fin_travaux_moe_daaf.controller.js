(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_fin_travaux_moe_daafController', Validation_demande_fin_travaux_moe_daafController);
    /** @ngInject */
    function Validation_demande_fin_travaux_moe_daafController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
...
//col table
    ...
    apiFactory.getAPIgeneraliserREST("demande_fin_travaux_moe/index",'menu','getdemandeByValidedpfi').then(function(result)
    {
