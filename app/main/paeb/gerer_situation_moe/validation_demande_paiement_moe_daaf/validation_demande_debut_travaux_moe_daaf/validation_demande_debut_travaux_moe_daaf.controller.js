(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_debut_travaux_moe_daafController', Validation_demande_debut_travaux_moe_daafController);
    /** @ngInject */
    function Validation_demande_debut_travaux_moe_daafController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
...
/**********************************debut demande_debut_travaux_moe****************************************/
    apiFactory.getAPIgeneraliserREST("demande_debut_travaux_moe/index",'menu','getdemandeByValidedpfi').then(function(result)
    {
...
//col table
        ...
        vm.downloadJustificatif_debut_travaux_moe = function(item)
        {
