(function ()
{
    ...
    angular
        ...
        .controller('Validation_demande_latrine_moe_daafController', Validation_demande_latrine_moe_daafController);
    /** @ngInject */
    function Validation_demande_latrine_moe_daafController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,apiUrlFile)
    {
		    var vm = this;
...
/**********************************debut demande_latrine_moe****************************************/
      apiFactory.getAPIgeneraliserREST("demande_latrine_moe/index",'menu','getdemandeByValidedpfi').then(function(result)
      {
