        ...
        return {
          dataSource:
          {
            ...
            transport: {
              read: function (e)
              {
                apiFactory.getAPIgeneraliserREST("divers_attachement_latrine/index","menu","getattachementBytype_latrine","id_type_latrine",id_type_latrine).then(function(result)
                {
                    e.success(result.data.response)
                }, function error(result)
                  {
