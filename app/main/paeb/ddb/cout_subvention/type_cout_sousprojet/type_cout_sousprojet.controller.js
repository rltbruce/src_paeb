(function ()
{
    ...
    angular
        ...
        .controller('Type_cout_sousprojetController', Type_cout_sousprojetController);
    /** @ngInject */
    function Type_cout_sousprojetController($mdDialog, $scope, apiFactory, $state)
    {
		   var vm = this;
...
vm.mainGridOptions = {
       ...
       dataSource: new kendo.data.DataSource({   
         transport: {
              read: function (e)
              {
                apiFactory.getAll("type_cout_sousprojet/index").then(function(result)
                {
              ...
              update : function (e)
              {
                  ...
                  var datas = $.param({
                          ...
                          cout_sousprojet:   e.data.models[0].cout_sousprojet,
                          id_zone_subvention:   e.data.models[0].zone_subvention.id,      
                          id_acces_zone:        e.data.models[0].acces_zone.id               
                      });
                  
                  apiFactory.add("type_cout_sousprojet/index",datas, config).success(function (data)
                  {                
            ...
            schema:
            {
                model:
                {
                    ...
                    fields:
                    {
                        ...
                        cout_sousprojet: {type: "number", validation: {required: true}}
                    }
                }
            },     
          ...
          toolbar: [{               
               template: "<label id='table_titre'>Cout sous projet</label>"
          },{
               name: "create",
               text:"",
          ...
          columns: [
            ...
            {
              field: "cout_sousprojet",
              title: "Cout_sousprojet",
              width: "Auto"
            },
            { 
              title: "Action",
