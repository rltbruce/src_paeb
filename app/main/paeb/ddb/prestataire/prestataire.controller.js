(function ()
{
    ...
    function PrestataireController($mdDialog, $scope, apiFactory, $state)
    {
        ...
        //col table
        vm.prestataire_column = [{titre:"Code"},{titre:"Nom"},{titre:"Nif"},{titre:"Stat"},{titre:"Siege"},{titre:"Action"}];
            ...
            apiFactory.add("prestataire/index",datas, config).success(function (data)
            {
                if (NouvelItem == false)
                {
                    ...
                    if(suppression==0)
                    {
                        ...
                        vm.selectedItem.code       = prestataire.code;
                ...
                else
                {
                  ...
                  prestataire.code=  prestataire.code;
